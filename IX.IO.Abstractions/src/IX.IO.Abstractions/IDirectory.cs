...
namespace IX.IO.Abstractions
{
    public interface IDirectory
    {
        ...
        /// <summary>
        /// Enumerates all the filesystem entries contained at a certain directory.
        /// </summary>
        /// <param name="path">The path of the directory.</param>
        /// <returns>An enumerable of filesystem entry paths.</returns>
        IEnumerable<string> EnumerateFileSystemEntries(string path);

        /// <summary>
        /// Enumerates the filesystem entries contained at a certain directory with a specific search pattern.
        /// </summary>
        /// <param name="path">The path of the directory.</param>
        /// <param name="searchPattern">The search pattern to use.</param>
        /// <returns>An enumerable of filesystem entry paths.</returns>
        ...
        /// </summary>
        /// <param name="path">The path of the directory.</param>
        /// <returns>An array of filesystem entry paths.</returns>
        ...
        /// <param name="path">The path of the directory.</param>
        /// <param name="searchPattern">The search pattern to use.</param>
        /// <returns>An array of filesystem entries paths.</returns>
