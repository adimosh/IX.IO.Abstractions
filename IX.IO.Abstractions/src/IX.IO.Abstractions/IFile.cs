...
{
    /// <summary>
    /// Abstracts the <see cref="System.IO.File"/> class' static methods into a mockable interface. 
    /// </summary>
    public interface IFile
    {
        ...
        /// <summary>
        /// Opens a <see cref="System.IO.StreamWriter"/> to append text to a file.
        /// </summary>
        /// <param name="path">The path of the file.</param>
        /// <returns>A <see cref="System.IO.StreamWriter"/> that can write to a file.</returns>
        ...
        /// <returns>A <see cref="System.IO.Stream"/> that can read from and write to a file.</returns>
        Stream Create(string path, int bufferSize = 4096);

        /// <summary>
        /// Opens a <see cref="System.IO.StreamWriter"/> to write text to a file.
        /// </summary>
        /// <param name="path">The path of the file.</param>
        /// <returns>A <see cref="System.IO.StreamWriter"/> that can write to a file.</returns>
        ...
        /// </summary>
        /// <param name="path">The path of the file.</param>
        /// <returns>A <see cref="System.DateTime"/> in UTC.</returns>
        ...
        /// <summary>
        /// Opens a <see cref="System.IO.Stream"/> to read from a file.
        /// </summary>
        /// <param name="path">The path of the file.</param>
        /// <returns>A <see cref="System.IO.Stream"/> that can read from a file.</returns>
        Stream OpenRead(string path);

        /// <summary>
        /// Opens a <see cref="System.IO.StreamReader"/> to read text from a file.
        /// </summary>
        /// <param name="path">The path of the file.</param>
        /// <returns>A <see cref="System.IO.StreamReader"/> that can read from a file.</returns>
        StreamReader OpenText(string path);

        /// <summary>
        /// Opens a <see cref="System.IO.Stream"/> to write to a file.
        /// </summary>
        /// <param name="path">The path of the file.</param>
        /// <returns>A <see cref="System.IO.Stream"/> that can write to a file.</returns>
